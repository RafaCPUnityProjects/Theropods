...
public class KickStarter : MonoBehaviour
{
	...
	private void Awake ()
	{
		...
		if (references)
		{
			...
			{
				Debug.LogError ("No Cursor Manager found - please set one using the Adventure Creator Kit wizard");
			}

			if (menuManager == null)
			{
				Debug.LogError ("No Menu Manager found - please set one using the Adventure Creator Kit wizard");
			}
