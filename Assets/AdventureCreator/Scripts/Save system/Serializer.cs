...
public class Serializer : MonoBehaviour
{
	...
	public static string SerializeObjectCSV (object data)
	{
		string d = "";

		FieldInfo[] info = data.GetType().GetFields();
	...
	public static SaveData DeserializeObjectCSV (string s)
	{
		...
		foreach (FieldInfo i in info)
		{
			i.SetValue (data, System.Convert.ChangeType (str[index], i.GetType()));
			index ++;
		}
