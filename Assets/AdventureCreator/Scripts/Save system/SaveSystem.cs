...
namespace AC
{
	...
	public class SaveSystem : MonoBehaviour
	{
		...
		public void ImportSaveGame (int saveID)
		{
			...
			if (allData.ToString () != "")
			{
				KickStarter.eventManager.Call_OnImport (false);
				...
				KickStarter.eventManager.Call_OnImport (true);
			}
		}
		...
		public void LoadSaveGame (int saveID)
		{
			...
			if (allData.ToString () != "")
			{
				KickStarter.eventManager.Call_OnLoad (false);
		...
		private void _OnLevelWasLoaded ()
		{
			...
			if (loadingGame == LoadingGame.InNewScene || loadingGame == LoadingGame.InSameScene)
			{
				...
				CustomLoadHook ();
				KickStarter.eventManager.Call_OnLoad (true);
		...
		public bool SaveSaveGame (int saveID, bool overwriteLabel = true, string newLabel = "")
		{
			...
			KickStarter.eventManager.Call_OnSave (false);
			CustomSaveHook ();
			...
			KickStarter.eventManager.Call_OnSave (true);
			return true;
		}
