...
namespace AC
{
	...
	public class EventManager : MonoBehaviour
	{
		...
		/**
		 * <summary>Triggers either the OnBeforeSaving or OnFinishSaving events.</summary>
		 * <param name = "isAfter">If True, OnFinishSaving will be triggered. If False, OnBeforeSaving will be triggered</param>
		 */
		public void Call_OnSave (bool isAfter)
		{
			if (isAfter && OnFinishSaving != null)
			{
				OnFinishSaving ();
			}
			else if (!isAfter && OnBeforeSaving != null)
			{
				OnBeforeSaving ();
			}
		}
		...
		/**
		 * <summary>Triggers either the OnBeforeLoading or OnFinishLoading events.</summary>
		 * <param name = "isAfter">If True, OnFinishLoading will be triggered. If False, OnBeforeLoading will be triggered</param>
		 */
		public void Call_OnLoad (bool isAfter)
		{
			if (isAfter && OnFinishLoading != null)
			{
				OnFinishLoading ();
			}
			else if (!isAfter && OnBeforeLoading != null)
			{
				OnBeforeLoading ();
			}
		}
		...
		/**
		 * <summary>Triggers either the OnBeforeImporting or OnFinishImporting events.</summary>
		 * <param name = "isAfter">If True, OnFinishImporting will be triggered. If False, OnBeforeImporting will be triggered</param>
		 */
		public void Call_OnImport (bool isAfter)
		{
			if (isAfter && OnFinishImporting != null)
			{
				OnFinishImporting ();
			}
			else if (!isAfter && OnBeforeImporting != null)
			{
				OnBeforeImporting ();
			}
		}
