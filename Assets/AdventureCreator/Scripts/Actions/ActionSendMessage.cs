...
public class ActionSendMessage : Action
{
	...
	override public float Run ()
	{
		if (constantID != 0)
		{
			// Attempt to find the correct scene object, and set it as linkedObject
	...
	public void ShowGUI (GameObject selfObject)
	{
		if (selfObject == null)
		{
			constantID = EditorGUILayout.IntField ("Constant ID number:", constantID);
		}
		else
		{
			if (selfObject == null)
