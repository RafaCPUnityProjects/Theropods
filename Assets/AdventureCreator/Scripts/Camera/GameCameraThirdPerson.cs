...
public class GameCameraThirdPerson : _Camera
{
	...
	private void FixedUpdate ()
	{
		...
		if (stateHandler && stateHandler.gameState == AC.GameState.Normal)
		{
			...
			if (toggleCursor && !playerInput.CanMoveMouse ())
			{
				inputMovement = playerInput.freeAim;
			}

			if ((toggleCursor && !playerInput.CanMoveMouse ()) || !toggleCursor)
			{
