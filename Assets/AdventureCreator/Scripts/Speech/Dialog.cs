...
public class Dialog : MonoBehaviour
{
	...
	public Vector2 GetCharScreenCentre ()
	{
		...
		if (speakerChar.GetComponent<Collider>() is CapsuleCollider)
		{
			CapsuleCollider capsuleCollder = (CapsuleCollider) speakerChar.GetComponent<Collider>();
	...
	private IEnumerator EndMessage ()
	{
		...
		if (speakerChar)
		{
			...
			{
				foreach (AnimationState state in speakerChar.GetComponent <Animation>().GetComponent<Animation>())
				{
